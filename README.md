...
I&apos;m a software engineer experienced in building scalable backend systems with tools like [TypeScript](https://www.typescriptlang.org), [Node](https://nodejs.org), [Redis](https://redis.io), [Kafka](https://kafka.apache.org), and [Docker](https://www.docker.com). Currently, I&apos;m building [Currunt](https://currunt.abhiarya.in) an open-sourced unified AI suite.
